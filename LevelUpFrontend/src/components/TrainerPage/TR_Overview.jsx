...
const TR_Overview = () => {
  ...
  const stats = [
    { title: 'Total Trainee', value: '24', icon: <Users className="w-8 h-8 text-blue-400" />, color: 'text-blue-500' },
    { title: 'Pending Tasks', value: '10', icon: <Clock className="w-8 h-8 text-red-400" />, color: 'text-red-500' },
    { title: 'Completed Tasks', value: '35', icon: <Flag className="w-8 h-8 text-purple-400" />, color: 'text-purple-500' }
  ];

  const recentActivity = [
    { name: 'Malou Canedo', action: 'Submitted work log', time: '5 minutes ago', status: 'Pending', statusColor: 'bg-orange-100 text-orange-600' },
    { name: 'Zach Bihag', action: 'Submitted work log', time: '5 minutes ago', status: 'Completed', statusColor: 'bg-green-100 text-green-600' },
    { name: 'Kurt Cabural', action: 'Submitted work log', time: '5 minutes ago', status: 'Warning', statusColor: 'bg-red-100 text-red-600' }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-100 via-purple-100 to-pink-100">
      {/* Header */}
